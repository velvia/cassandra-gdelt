...
public class LongVector extends Table {
  public static LongVector getRootAsLongVector(ByteBuffer _bb) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (new LongVector()).__init(_bb.getInt(_bb.position()) + _bb.position(), _bb); }
